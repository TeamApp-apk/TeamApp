        ...
        Column(
            ...
            Column(Modifier
                ...
                OutlinedTextField(
                    ...
                    label = { Text(text = "Twoja wiadomość", fontFamily =FontFamily(Font(R.font.proximanovalight)),color = Color(0xFF003366)) },
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(10.dp),
                    textStyle = TextStyle(
                    ...
                    keyboardOptions = KeyboardOptions.Default.copy(
                        ...
                        unfocusedBorderColor = Color.Transparent // Transparent border when unfocused
                    )
                )
            ...
            Button(
                onClick = {
                    // Action when the button is clicked, e.g., send the message
                },
                modifier = Modifier
                    .fillMaxWidth()
                ...
                Text(text = "Wyślij", color = Color.White,fontFamily = FontFamily(Font(R.font.proximanovabold)))
            }
